...
async function main() {
  ...
  console.log('\n📋 Demo Accounts:')
  console.log('Admin: admin@medfoxrcm.com / password123')
  console.log('Biller: biller@medfoxrcm.com / password123')
  console.log('Coder: coder@medfoxrcm.com / password123')
  console.log('Client: client@medfoxrcm.com / password123')
}
