...
- **Admin**: admin@medfoxrcm.com / password123
- **Biller**: biller@medfoxrcm.com / password123
- **Coder**: coder@medfoxrcm.com / password123
- **Client**: client@medfoxrcm.com / password123
...
```bash
docker build -t medfoxrcm .
docker run -p 3000:3000 medfoxrcm
```
